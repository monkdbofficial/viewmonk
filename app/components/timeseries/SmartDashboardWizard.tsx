                    ...
                    >
                      ...
                      <div className={`relative h-40 p-6 overflow-hidden ${
                        isSelected
                          ...
                          : 'bg-gradient-to-br from-gray-700 to-gray-800 dark:from-gray-700 dark:to-gray-900'
                      } group-hover:scale-105 transition-transform duration-300`}>
                        {/* Decorative dashboard mockup */}
                        <div className="absolute inset-0 opacity-20">
                          <div className="grid grid-cols-3 gap-2 p-4 h-full">
                            <div className="col-span-2 bg-white/30 rounded-lg"></div>
                        ...
                        <div className="relative z-10 mt-4">
                          <span className="inline-flex items-center gap-1 text-xs font-semibold px-3 py-1 bg-white/20 backdrop-blur-sm text-white rounded-full border border-white/30">
                      ...
                      <div className="p-6">
                        ...
                        <div className="mb-4">
                          ...
                          <div className="flex flex-wrap gap-2">
                            ...
                            {template.widgetTypes.length > 5 && (
                              <span className="text-xs font-medium px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 rounded-full border border-gray-200 dark:border-gray-600">
                                +{template.widgetTypes.length - 5}
                              </span>
                            )}
                          </div>
                        ...
                        <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                          ...
                          <span>Works best with: {template.recommendedTables.slice(0, 2).join(', ')}</span>
                          {template.recommendedTables.length > 2 && (
                            <span className="font-semibold">+{template.recommendedTables.length - 2} more</span>
                          )}
                        </div>
                      </div>
                      ...
                      {isSelected && (
                        <div className="absolute top-0 right-0 w-24 h-24">
                          <div className="absolute top-0 right-0 w-0 h-0 border-t-[48px] border-r-[48px] border-t-blue-600 border-r-transparent"></div>
              ...
              <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-950/30 rounded-xl border border-blue-200 dark:border-blue-800">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-blue-900 dark:text-blue-300">
                    <span className="font-semibold">Pro Tip:</span> Each template is pre-configured with optimal chart types and layouts for your data.
